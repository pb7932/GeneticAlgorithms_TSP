...
class r0924552:
    ...
    def optimize(self, filename):
        ...
        while tsp.convergenceTest():
			...
			# Your code here.
            print('{} mean: {} best: {}'.format(cnt,meanObjective, bestObjective))
...
class TravelingSalesman:
    ...
    def getEdgesOfIndividual(self, ind: np.ndarray) -> list:
        """ Creates a list of tuples of edges of an individual. """
        edges = []
        for i in range(len(ind)-1):
            first = ind[i]
            second = ind[i+1]
    ...
    def fitnessWrapper(self, pop, pop_fitness):
        ...
        alpha = 0.25
        sigma = len(self.distanceMatrix) / 2
